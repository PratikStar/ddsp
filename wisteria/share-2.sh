...
#--input_audio_filepatterns='/work/gk77/k77021/data/di_1_one_clip/*wav' \
#--output_tfrecord_path=/work/gk77/k77021/data/ddsp/tfrecord-di_1_one_clip-sr44k-fr1000/train.tfrecord \
#--chunk_secs=0.0 \
#--frame_rate=1000 \
#--num_shards=10 \
#--example_secs=4 \
...
--mode=train \
--run_name=ae_di_1_one_clip_sr44k-fr1000 \
...
--gin_param="TFRecordProvider.file_pattern='/work/gk77/k77021/data/ddsp/tfrecord-di_1_one_clip-sr44k-fr1000/train.tfrecord*'" \
